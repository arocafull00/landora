...
export const VELAR_DEFAULT_CONTENT: TemplateContentMap["velar"] = {
  ...
  nav: [
    { id: "nav-story", label: "Nosotros", href: "#historia" },
    { id: "nav-listings", label: "Galería", href: "#galeria" },
    { id: "nav-residences", label: "Espacios", href: "#espacios" },
    { id: "nav-inquire", label: "Contacto", href: "#contacto" },
  ],
