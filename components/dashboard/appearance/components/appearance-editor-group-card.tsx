  ...
  return (
    ...
    >
      <CollapsibleTrigger asChild>
        <button
          className="flex w-full min-w-0 items-center justify-between gap-3 px-4 py-4 text-left outline-none transition-colors hover:bg-surface-container-low focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary"
          type="button"
        >
          {header}
        </button>
