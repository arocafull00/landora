...
export function SignalCtaButton({
  ...
  return (
    <a
      className="group relative inline-flex items-center gap-3 overflow-hidden border border-[var(--site-on-dark)] bg-transparent px-6 py-4 text-[11px] font-semibold uppercase tracking-[0.2em] text-[var(--site-on-dark)] transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--site-accent)]"
      href={href}
