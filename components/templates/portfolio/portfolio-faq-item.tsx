  ...
  return (
    <details className="group border-b border-[var(--site-border)]" open={defaultOpen}>
      <summary className="flex cursor-pointer list-none items-center justify-between py-5 text-left">
        ...
        <ChevronDown aria-hidden className="size-5 shrink-0 text-[var(--site-text-muted)] transition-transform group-open:rotate-180 motion-reduce:transition-none" />
      </summary>
      <p className="pb-5 leading-relaxed text-[var(--site-text-muted)] text-site-content">
        {item.answer}
      </p>
    </details>
  );
