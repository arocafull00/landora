  ...
  return (
    <section id="testimonios" className="scroll-mt-24 bg-[var(--site-dark)] px-6 py-24 md:px-10 md:py-32 lg:px-16">
      <div className="mx-auto max-w-6xl">
        <div className="mb-16 border-b border-[var(--site-on-dark)]/10 pb-12" data-aos="fade-up">
          <span
            aria-hidden
            className="mb-6 block text-[clamp(64px,10vw,96px)] leading-none text-[var(--site-on-dark)]/20"
        ...
        {rest.length > 0 && (
          ...
          >
            {rest.map((testimonial) => (
              <div className="border-t border-[var(--site-on-dark)]/10 pt-6" key={testimonial.id}>
