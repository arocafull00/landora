...
export function FloristeriaNavPillLink({ link }: { link: NavLink }) {
  return (
    <li>
      <TemplateNavAnchor
        className="rounded-full px-4 py-2 font-medium text-[var(--site-text)]/70 transition-colors hover:bg-[var(--site-primary)]/5 hover:text-[var(--site-primary)] lg:px-5 text-site-content"
        href={link.href}
