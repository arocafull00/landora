  ...
  return (
    ...
    >
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col items-center">
        ...
        >
          {hero.eyebrow ? (
            <p className="mb-5 font-body font-semibold uppercase tracking-[0.24em] text-[var(--site-primary)] text-site-content">
              {hero.eyebrow}
            </p>
          ) : null}
          <h1 className="text-balance font-headline font-medium leading-[0.92] tracking-[-0.055em] text-site-title-lg">
            {hero.title}
          </h1>
          {hero.subtitle ? (
            <p className="mt-7 max-w-2xl text-pretty font-body leading-relaxed text-[var(--site-text-muted)] text-site-subtitle">
              {hero.subtitle}
            </p>
          ) : null}
          {hero.description ? (
            <p className="mt-3 max-w-xl text-pretty font-body leading-relaxed text-[var(--site-text-muted)] text-site-content">
              {hero.description}
            </p>
          ) : null}
